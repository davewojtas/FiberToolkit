...
#plt.subplot(3,1,1)
#plt.hist(litpix, bins=200)
#plt.subplot(3,1,2)
#plt.hist(mcounts, bins=200)
#plt.subplot(3,1,3)
...
#print "Enter ratio_thresh"
#ratio_thresh = float((sys.stdin.readline()).rstrip())
hit_indices = np.where((litpix>20000) & (ratios>2))[0]
print 'hit_indices:'
print hit_indices
# End hit logic ==========================
